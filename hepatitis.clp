...
(deffacts tree
  (node (name HBsAg-positive) (question "HBs Ag?") (positive-node anti-HDV-negative) (negative-node anti-HBs-positive-1))
  (node (name anti-HBs-positive-1) (question "Anti-HBs?") (positive-node anti-HBc-positive-1) (negative-node anti-HBc-positive-2))
  (node (name anti-HBc-positive-1) (question "Anti-HBc?") (positive-node cured) (negative-node vaccinated))
  (node (name anti-HBc-positive-2) (question "Anti-HBc?") (positive-node unclear) (negative-node healthy))
  ...
  (node (name anti-HDV-negative) (question "Anti-HDV?") (positive-node hepatitis) (negative-node anti-HBc-positive-3))
  (node (name anti-HBc-positive-3) (question "Anti-HBc?") (positive-node anti-HBs-positive-2) (negative-node uncertain))
  (node (name anti-HBs-positive-2) (question "Anti-HBs?") (positive-node uncertain) (negative-node lgm-anti-HBc-positive))
  (node (name lgm-anti-HBc-positive) (question "lgm Anti-HBc?") (positive-node acute) (negative-node chronic))
